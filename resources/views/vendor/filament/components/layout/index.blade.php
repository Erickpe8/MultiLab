...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div
        class="fi-layout flex min-h-screen w-full flex-row-reverse overflow-x-clip gap-6 lg:gap-8"
    >
        <div
            ...
            @endif
            @class([
                'fi-main-ctn flex-1 flex-col lg:ms-[calc(var(--sidebar-width)+1.5rem)]',

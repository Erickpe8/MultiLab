...
return [
    ...
    'attributes'      => [
        'scheduled_start_at' => 'inicio programado',
        'scheduled_end_time' => 'fin programado',
    ],
    ...
    'custom'           => [
        'scheduled_start_at' => [
            'after_or_equal' => 'El :attribute debe ser una fecha posterior o igual al momento actual.',
        ],
    ],
